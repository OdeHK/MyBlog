            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    ...
                    <div class="blog-content">
                        ...
                        <img src="{{$post->imageUrl()}}" alt="" class="img-fluid img-fullwidth">
                        ...
                        <div class="col-lg-12">
                            <div class="banner-spot clearfix">
                                <div class="banner-img">
                                    <img src="/web/upload/banner_01.jpg" alt="" class="img-fluid">
                                </div><!-- end banner-img -->
                            </div><!-- end banner -->
                        </div><!-- end col -->
                    </div><!-- end row -->
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <img src="/web/upload/author.jpg" alt="" class="img-fluid rounded-circle">
                            </div><!-- end col -->
                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="tech-single.html" title="">
                                                <img src="{{$relate->imageUrl()}}" alt="" class="img-fluid">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="{{route('web.post', $relate->slug)}}"
                                                    title="">{{$relate->title}}</a>
                                            </h4>
                                            <small><a href="{{route('web.category', $relate->category->slug)}}"
                                                    title="">{{$relate->category->name}}</a></small>
                                            <small>{{\Carbon\Carbon::parse($relate->created_at)->format('d-m-Y')}}</small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                            @endforeach
                                    ...
                                    @foreach($comments as $comment)
                                        <div class="media">
                                            <a class="media-left" href="#">
                                                <img src="/web/upload/author.jpg" alt="" class="rounded-circle">
                                            </a>
